            ...
            <div className='w-full sm:w-[60%] h-[60px]  flex flex flex-col sm:flex-row items-center justify-between '>
                <div className='w-[35%]  h-full flex items-center justify-center cursor-pointer mt-2'>
                    <div className='w-full h-[40px]  rounded-[10px] flex items-center justify-center border border-[2px] border-white-400 hover:border-[1px] gap-1 '>
                        <p className='font-robotoMono text-green-400 font-bold text-xs '>
                            <a
                                href="/RohithKrishnaRResume.pdf "
                                download
                ...
                <div className='w-[60%] h-full mt-7 md:mt-2  flex items-center justify-around'>
                    {
                        icons?.map((item) => (
                            <div style={{ width: '30px', height: '30px' }} className=' flex items-center justify-center cursor-pointer border-[1px] border-green-700  p-2 rounded-full'> <a href={item?.link}>{item?.icon}</a></div>
                        ))
                    }
                </div>
