  ...
  return (
    <Box
      ...
      <div className="w-2/4 h-full flex items-center justify-end">
        <div id="one" style={{backgroundColor:'#212529'}} className="block w-[50%] h-[80%] rounded-md  py-3">
            {/* <img src={aboutpic}  style={{width:'100%',height:'100%',objectFit:'contain',borderRadius:10}} alt="" /> */}
             <img src={aboutpic} alt="Image 1" className="fade-img img1" />
        <img src={aboutpic2} alt="Image 2" className="fade-img img2" />
        </div>
      </div>
      <div className="w-3/4 h-full  ">
        <div className="w-full h-1/2  flex items-center flex-col gap-1 justify-center ">
        ...
        <div className="w-full h-1/2  flex items-start justify-between">
