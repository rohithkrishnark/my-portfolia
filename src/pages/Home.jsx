...
import mypic from '../assets/new2.jpeg'
...
const icons = [
  ...
  {
    name: "InstagramIcon",
    link: "https://www.instagram.com/_._rohith_._36?igsh=MTVwZG53NHVkeDE4",
    icon: <InstagramIcon
      sx={{
        fontSize: 23,
        color: 'white',
  ...
  {
    name: "EmailIcon",
    link: "mailto:rohithkrishnaofficialwk@gmail.com",
    icon: <EmailIcon
      sx={{
        fontSize: 23,
        color: 'white',
    ...
    <Box sx={{ width: '100%', height: '100vh' }} className="relative z-10  bg-black">
      ...
      <div className='w-[100%] h-[85%] flex items-center justify-center'>
        <Box className=" h-full mx-auto flex flex-col lg:flex-row items-center justify-between"
          ...
          <div id='first' className="order-2 lg:order-1 w-full lg:w-[65%]  h-1/2 lg:h-full py-8 flex flex-col text-center sm:text-left  justify-center">
            <OwnerDetails
          ...
          <div id='second' className="order-1 lg:order-2  w-full lg:w-[35%] h-1/2 lg:h-full flex py-4  justify-center items-center">
